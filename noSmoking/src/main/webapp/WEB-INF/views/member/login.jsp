...
<title>Insert title here</title>
	...
	<link rel="stylesheet" href="/smoking/resources/css/member/login.css">
        ...
        <form action="loginMember.me" method="post">
            ...
            <div class="login-footer">
                ...
                <div align="center" class="find-join-area">
                    ...
                    <div class="login-join" onclick="location.href ='insertMember.me'">회원가입</div>
                </div>
             </div>
        </form>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="find-modal-body">
                    <div class="find-id-div"><button class="btn btn-primary find-id-btn" onclick="">아이디 찾기</button></div>
                    <div class="find-password-div"><button class="btn btn-primary find-password-btn" onclick="">비밀번호 찾기</button></div>
                </div>
                <div class="find-area">
                </div>
